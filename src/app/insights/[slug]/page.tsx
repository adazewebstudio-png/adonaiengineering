...
const components = {
    ...
    block: {
        h2: ({ children }: any) => <h2 className="text-2xl md:text-3xl font-bold uppercase tracking-tight mt-12 mb-6 text-foreground">{children}</h2>,
        h3: ({ children }: any) => <h3 className="text-xl md:text-2xl font-bold uppercase tracking-tight mt-10 mb-4 text-foreground">{children}</h3>,
        normal: ({ children }: any) => <p className="text-muted-foreground leading-relaxed mb-6">{children}</p>,
        blockquote: ({ children }: any) => (
            <blockquote className="border-l-4 border-primary pl-6 py-2 italic text-xl text-foreground my-8">
                {children}
            </blockquote>
        ),
    },
        ...
        <div className="flex flex-col min-h-screen pt-[88px]">
            <div className="bg-zinc-100 dark:bg-zinc-900 border-b border-border">
                <div className="container px-4 md:px-6 py-4">
                    <Link href="/insights" className="inline-flex items-center text-sm font-bold uppercase tracking-widest text-muted-foreground hover:text-primary transition-colors">
            ...
            <article className="container py-20 px-4 md:px-6">
                <div className="max-w-3xl mx-auto">
                    <div className="mb-12">
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-6xl font-black uppercase tracking-tighter mb-8 leading-[1.1] text-foreground">
                            {post.title}
                        </h1>
